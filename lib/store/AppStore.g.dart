...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$vehicleImageAtom =
      Atom(name: '_AppStore.vehicleImage', context: context);

  @override
  String get vehicleImage {
    _$vehicleImageAtom.reportRead();
    return super.vehicleImage;
  }

  @override
  set vehicleImage(String value) {
    _$vehicleImageAtom.reportWrite(value, super.vehicleImage, () {
      super.vehicleImage = value;
    });
  }
  ...
  late final _$setVehicleImageAsyncAction =
      AsyncAction('_AppStore.setVehicleImage', context: context);

  @override
  Future<void> setVehicleImage(String val, {bool isInitializing = false}) {
    return _$setVehicleImageAsyncAction
        .run(() => super.setVehicleImage(val, isInitializing: isInitializing));
  }
