  ...
  factory AppSettingModel.fromJson(Map<String, dynamic> json) {
    return AppSettingModel(
      ...
      notification_settings: json['notification_settings'] != null
          ...
          : null,
      site_copyright:
          json['site_copyright'] != null ? json['site_copyright'] : "",
      site_description:
          json['site_description'] != null ? json['site_description'] : "",
      ...
      support_number:
          json['support_number'] != null ? json['support_number'] : "",
  ...
  factory NotificationSettings.fromJson(Map<String, dynamic> json) {
    return NotificationSettings(
      active: json['active'] != null
          ? Notifications.fromJson(json['active'])
          : null,
      cancelled: json['cancelled'] != null
          ? Notifications.fromJson(json['cancelled'])
          : null,
      completed: json['completed'] != null
          ? Notifications.fromJson(json['completed'])
          : null,
      courier_arrived: json['courier_arrived'] != null
          ? Notifications.fromJson(json['courier_arrived'])
          : null,
      courier_assigned: json['courier_assigned'] != null
          ? Notifications.fromJson(json['courier_assigned'])
          : null,
      courier_departed: json['courier_departed'] != null
          ? Notifications.fromJson(json['courier_departed'])
          : null,
      courier_picked_up: json['courier_picked_up'] != null
          ? Notifications.fromJson(json['courier_picked_up'])
          : null,
      courier_transfer: json['courier_transfer'] != null
          ? Notifications.fromJson(json['courier_transfer'])
          : null,
      create: json['create'] != null
          ? Notifications.fromJson(json['create'])
          : null,
      delayed: json['delayed'] != null
          ? Notifications.fromJson(json['delayed'])
          : null,
      failed: json['failed'] != null
          ? Notifications.fromJson(json['failed'])
          : null,
      payment_status_message: json['payment_status_message'] != null
          ? Notifications.fromJson(json['payment_status_message'])
          : null,
    );
  }
